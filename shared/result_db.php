...
class result_db
{
	private static $con=null;
        ...
        public function insertResult($_id,$_type,$_email,$_rno,$_year,$_sem,$_gpa,$_sub1,$_sub1_marks,$_sub2,$_sub2_marks,$_sub3,$_sub3_marks,$_sub4,$_sub4_marks,$_sub5,$_sub5_marks,$_sub6,$_sub6_marks,$_sub7,$_sub7_marks,$_sub8,$_sub8_marks,$_sub9,$_sub9_marks)
		{
			$cnn=result_db::connect();
			
			$sql="INSERT INTO result_tbl VALUES (".$_id.",".$_type.",'" .$_email." '," .$_rno." ," .$_year." ," .$_sem.",'" .$_gpa." ',' ".$_sub1." '," .$_sub1_marks. ",'" .$_sub2. "'," .$_sub2_marks. ",'". $_sub3. "'," .$_sub3_marks. ",'" .$_sub4. "'," .$_sub4_marks .",'". $_sub5 ."',".$_sub5_marks.",'".$_sub6."',".$_sub6_marks.",'".$_sub7."',".$_sub7_marks.",'".$_sub8."',".$_sub8_marks.",'".$_sub9."',".$_sub9_marks.") ";
		...
		public function updateResult($_id,$_type,$_email,$_rno,$_year,$_sem,$_gpa,$sub1,$sub1_marks,$sub2,$sub2_marks,$sub3,$sub3_marks,$sub4,$sub4_marks,$sub5,$sub5_marks,$sub6,$sub6_marks,$sub7,$sub7_marks,$sub8,$sub8_marks,$sub9,$sub9_marks)
		{
		...
		public function getStudentEmail($_rno)
		{
			$cnn=result_db::connect();
			$sql="SELECT s.fk_email_id FROM student_tbl s , result_tbl r where s.pk_stu_rno & r.fk_stu_rno =".$_rno;
			$res=$cnn->query($sql);
			return $res;
			result_db::disconnect();
