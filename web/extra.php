...
<body>
	...
	<div class="header-bot">
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<h1>K.S School of Business Management</h1>
			
					<h5 align="right">	<span class="fa fa-phone" aria-hidden="true"></span> Tel No. (079) 26305972</h3>
				...
				<nav class="navbar navbar-default">
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							...
							<li class="active">
									<a class="nav-stylehead" href="index.html">Culture
										<span class="sr-only">(current)</span>
									</a>
								</li>
							<li class="dropdown">
							...
							<ul class="dropdown-menu agile_short_dropdown">
								...
								<li>
								<a href="images/academic.pdf">ACADEMIC CALENDER</a>
								<li>
								<a href="images/Academic_MBA.pdf">MBA</a>
							
							</li><li>
								<a href="images/Academic_Msc.pdf">M.SC.(CA & IT)</a>
							
							</li>
							</li>
							<li>
								<a href="images/holiday.pdf">LIST OF HOLIDAYS</a>
							</li>
							</ul>
						</li>
						<li class="dropdown">
							...
							<ul class="dropdown-menu agile_short_dropdown">
								<li>
									<a href="icons.html">MBA</a>
								</li>
								<li>
									<a href="typography.html">M.SC.(CA & IT)</a>
								</li>
...
echo '	<div id="myCarousel" class="carousel slide" data-ride="carousel">';
  ...
  echo '<ol class="carousel-indicators">';
	...
	echo'<img src="images/banner2.jpg" alt="Los Angeles">';
    echo'</div>';

    echo'<div class="item">';
	echo'<img src="images/banner2.jpg" alt="Chicago">';
    echo'</div>';

    echo'<div class="item">';
	echo'<img src="images/banner2.jpg" alt="New York">';
    echo'</div>';
	echo'</div>';
 ...
 // <!-- Wrapper for slides -->
	...
	/*	
	  ...
	  while($row=$result->fetch_assoc())
	  {
		...
		//<!-- Indicators -->
		echo '<ol class="carousel-indicators">';
		 echo ' <li data-target="#myCarousel" data-slide-to="'.$row["pk_slider_id"].'" class="active"></li>';

		echo '</ol>';
		echo '<div class="carousel-inner">';
		echo '<div class="item active">';
		  echo '<img src="'.$row["slider_img"].'">';
		  echo '</div>';
		  echo '</div>';
...
<?php
 /* <div class="carousel-inner">
    <div class="item active">
      <img src="image/banner1.jpg" alt="Los Angeles">
    </div>*/
?>
   <!-- <div class="item">
			...
			<!-- footer third section -->
				...
				<div class="col-sm-5 address-right">
					...
					<div class="col-xs-6 footer-grids ">
						...
						<ul>
							...
							<li>
								<a href="product2.html">Gallery</a>
							</li>
							<li>
								<a href="product.html">Gujarat University</a>
							</li>
						</ul>
					</div>
					<div class="clearfix"></div>
				...
				<div class="col-sm-5 address-right">
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							<li>
								<a href="about.html">Advent</a>
							</li>
							<li>
								<a href="contact.html">Melange</a>
							</li>
							<li>
								<a href="help.html">Technomantra</a>
							</li>
